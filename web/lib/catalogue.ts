/* UKAVA product catalogue — transcribed from the supplied UKAVA catalogues.
   Source of truth: UKAVA_Product_Catalogue_Website_Content.docx
...
export type Product = {
  ...
  cat: CategoryKey;
  type: string;
  /** The three headline specs shown on cards and in the detail hero. */
  primary: Spec[];
...
export type Category = { key: CategoryKey; label: string; intro: string };
...
const SCOOTER_FEATURES: Feature[] = [
...
const BATTERY_ADVANTAGES: Feature[] = [
...
function scooter(o: ScooterInput): Product {
  return {
    name: o.name,
    slug: slugify(o.name),
    cat: "electric-scooters",
    type: o.type || "Electric scooter",
    primary: [
...
function battery(o: BatteryInput): Product {
  return {
    name: o.name,
    slug: slugify(o.name),
    ...
    colours: [],
    groups: [
      { title: o.modelsLabel, rows: o.models.map((m) => ({ label: m, value: "" })) },
      {
        title: "Technology",
        rows: [
...
function linva(o: LinvaInput): Product {
  ...
  return {
    ...
    module: (solar ? [{ value: panels, label: "Recommended Solar Panels" }] : []).concat([
    ...
    groups: [
      ...
      solar
        ? {
            title: "Solar input",
            rows: [
              { label: "Recommended Solar Panels", value: panels },
              { label: "Power Source", value: "Solar and Battery Powered" },
            ],
          }
        : {
...
export const PRODUCTS: Product[] = [
  ...
  battery({
    ...
    warranty: "10 Years",
    modelsLabel: "Models",
    models: ["12.8V 100AH", "25.6V 100AH", "48V 100AH", "48V 200AH"],
  }),
  battery({
    name: "ESS (Energy Storage System)",
    type: "Energy storage system",
    headline: "48V to 360V",
    headlineLabel: "Range",
    warranty: "10 Years",
    modelsLabel: "Range",
    models: ["48V TO 360V, & 100AH ONWARDS"],
    extraGroups: [
      { title: "Commercial", rows: [{ label: "Rate", value: "RATE WILL BE AVAILABLE ON DEMAND" }] },
    ],
  }),
  battery({
    name: "Electric Three-Wheeler Lithium Battery",
    type: "Three-wheeler battery",
    headline: "51.2V / 60.8V",
    headlineLabel: "System voltage",
    warranty: "3 Years",
    modelsLabel: "Models",
    models: ["51.2V 100AH", "51.2V 150AH", "51.2V 200AH", "60.8V 100AH", "60.8V 150AH", "60.8V 200AH"],
  }),
  battery({
    name: "Electric Two-Wheeler Lithium Battery",
    type: "Two-wheeler battery",
    headline: "48V / 60V",
    headlineLabel: "System voltage",
    warranty: "3 Years",
    modelsLabel: "Available ranges",
    models: ["60V 20AH", "60V 24AH", "60V 32AH", "60V 36AH", "60V 40AH", "48V 18AH", "48V 24AH", "48V 30AH", "60V 18AH", "60V 30AH"],
  }),
  battery({
    name: "Rechargeable LFP Battery",
    type: "LFP battery",
    headline: "12.8V – 25.6V",
    headlineLabel: "Models available",
    warranty: "3 Years",
    modelsLabel: "Models",
