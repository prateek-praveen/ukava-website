export const PHONE_DISPLAY = "1800 212 2131";
export const PHONE_TEL = "tel:18002122131";

export function PhoneIcon({ size = 18, stroke = "currentColor" }: { size?: number; stroke?: string }) {
  return (
    <svg
      width={size}
      height={size}
